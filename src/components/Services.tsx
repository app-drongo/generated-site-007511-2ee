...
// Generated: 2025-08-20T03:03:09.047Z
// Section: services
// Category: services
  ...
  const services = [
    {
      ...
      description: "Seamless integration of your SAP systems",
      longDescription: "Our SAP integration experts help you connect your SAP applications with other enterprise systems, enabling data-driven decision making and optimized business processes.",
      icon: Cpu,
      benefits: [
        "Streamline data flows across your organization",
        "Improve operational efficiency and visibility",
        "Leverage real-time insights for strategic planning",
    ...
    },
    {
      ...
      description: "Transformative strategies for growth",
      longDescription: "Our business consulting services provide the expertise and guidance you need to navigate complex challenges and unlock new opportunities. We work closely with your leadership team to develop data-driven strategies that drive measurable results.",
      icon: BarChart3,
      benefits: [
      ...
      timeline: "4-12 weeks per engagement"
    },
    {
    ...
    },
    {
      ...
      description: "User-centric experiences that drive engagement",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Seamlessly integrate your SAP applications with other enterprise systems for enhanced data visibility, operational efficiency, and strategic decision-making.
          </p>
        </div>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-muted/50 text-center">
          <h3 className="text-2xl font-semibold mb-3">Optimize Your SAP Integration</h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Our experts will work closely with you to develop a tailored SAP integration strategy that aligns with your business goals and drives measurable results.
          </p>
          <Button size="lg">
